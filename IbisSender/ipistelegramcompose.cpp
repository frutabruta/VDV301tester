...
QString IpisTelegramCompose::slozeniTextuFront(QString LineName,QString DestinationName)
{
    qDebug() << Q_FUNC_INFO;
    QString vystup="";
...
QString IpisTelegramCompose::slozeniTextuRear(QString LineName)
{
    qDebug() << Q_FUNC_INFO;
    QString vystup="";
    // funkcni vystup+="aA1 <1B>b<1B>l<12><0A><1B><22><1B>l<12><1B>p<2D><1B><58>";
...
QString IpisTelegramCompose::slozeniTextuSideAA(QVector<StopPoint> nacestne,QString LineName,QString DestinationName)
{
    qDebug() << Q_FUNC_INFO;
    QString vystup="";
    vystup+="aA2 ";
...
QString IpisTelegramCompose::slozeniTextuJKZr1(QVector<StopPoint> nacestne,QString LineName)
{
    qDebug() << Q_FUNC_INFO;
...
QString IpisTelegramCompose::slozeniTextuJKZr2(QString DestinationName,QString LineName)
{
    qDebug() << Q_FUNC_INFO;
...
QString IpisTelegramCompose::slozeniTextuSideZN(QVector<StopPoint> nacestne)
{
    qDebug() << Q_FUNC_INFO;
    QString vystup="";
    vystup+="aA2 ";
