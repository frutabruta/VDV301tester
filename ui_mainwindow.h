...
public:
    ...
    QLabel *hlaseniLabel;
    QPushButton *pushButton_nast_hlaseniSlozka;
    QLineEdit *lineEditHlaseniCesta;
    QVBoxLayout *verticalLayout_2;
    QLabel *label_3;
    QLabel *NazevVysledku;
    QPushButton *pushButton_nast_pripojeni;
    ...
    QPushButton *pushButton_menu2_palPc;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->setMaximumSize(QSize(800, 538));
        ...
        page_palPc = new QWidget();
        page_palPc->setObjectName(QString::fromUtf8("page_palPc"));
        sizePolicy2.setHeightForWidth(page_palPc->sizePolicy().hasHeightForWidth());
        page_palPc->setSizePolicy(sizePolicy2);
        horizontalLayout_20 = new QHBoxLayout(page_palPc);
        ...
        pushButton_menu_linkospoj = new QPushButton(page_palPc);
        pushButton_menu_linkospoj->setObjectName(QString::fromUtf8("pushButton_menu_linkospoj"));
        QSizePolicy sizePolicy3(QSizePolicy::Minimum, QSizePolicy::Expanding);
        sizePolicy3.setHorizontalStretch(0);
        sizePolicy3.setVerticalStretch(0);
        sizePolicy3.setHeightForWidth(pushButton_menu_linkospoj->sizePolicy().hasHeightForWidth());
        pushButton_menu_linkospoj->setSizePolicy(sizePolicy3);
        pushButton_menu_linkospoj->setMinimumSize(QSize(0, 0));
        pushButton_menu_linkospoj->setMaximumSize(QSize(200, 200));
        QFont font;
        font.setPointSize(15);
        pushButton_menu_linkospoj->setFont(font);
        ...
        pushButton_menu_turnus = new QPushButton(page_palPc);
        pushButton_menu_turnus->setObjectName(QString::fromUtf8("pushButton_menu_turnus"));
        sizePolicy3.setHeightForWidth(pushButton_menu_turnus->sizePolicy().hasHeightForWidth());
        pushButton_menu_turnus->setSizePolicy(sizePolicy3);
        pushButton_menu_turnus->setMinimumSize(QSize(0, 0));
        pushButton_menu_turnus->setMaximumSize(QSize(200, 200));
        pushButton_menu_turnus->setFont(font);
        ...
        pushButton_menu_jizda = new QPushButton(page_palPc);
        pushButton_menu_jizda->setObjectName(QString::fromUtf8("pushButton_menu_jizda"));
        sizePolicy3.setHeightForWidth(pushButton_menu_jizda->sizePolicy().hasHeightForWidth());
        pushButton_menu_jizda->setSizePolicy(sizePolicy3);
        pushButton_menu_jizda->setMinimumSize(QSize(0, 0));
        pushButton_menu_jizda->setMaximumSize(QSize(200, 200));
        pushButton_menu_jizda->setFont(font);
        ...
        pushButton_menu_testRozhrani = new QPushButton(page_palPc);
        pushButton_menu_testRozhrani->setObjectName(QString::fromUtf8("pushButton_menu_testRozhrani"));
        sizePolicy3.setHeightForWidth(pushButton_menu_testRozhrani->sizePolicy().hasHeightForWidth());
        pushButton_menu_testRozhrani->setSizePolicy(sizePolicy3);
        pushButton_menu_testRozhrani->setMinimumSize(QSize(0, 0));
        pushButton_menu_testRozhrani->setMaximumSize(QSize(200, 200));
        ...
        sizePolicy4.setHeightForWidth(pushButton_menu_nastaveni->sizePolicy().hasHeightForWidth());
        pushButton_menu_nastaveni->setSizePolicy(sizePolicy4);
        pushButton_menu_nastaveni->setMinimumSize(QSize(0, 0));
        pushButton_menu_nastaveni->setMaximumSize(QSize(200, 200));
        pushButton_menu_nastaveni->setFont(font);
        pushButton_menu_nastaveni->setCheckable(true);
        pushButton_menu_nastaveni->setAutoExclusive(true);

        bocniMenu->addWidget(pushButton_menu_nastaveni);

        pushButton_menu_manual = new QPushButton(page_palPc);
        pushButton_menu_manual->setObjectName(QString::fromUtf8("pushButton_menu_manual"));
        sizePolicy3.setHeightForWidth(pushButton_menu_manual->sizePolicy().hasHeightForWidth());
        pushButton_menu_manual->setSizePolicy(sizePolicy3);
        pushButton_menu_manual->setMinimumSize(QSize(0, 0));
        pushButton_menu_manual->setMaximumSize(QSize(200, 200));
        pushButton_menu_manual->setFont(font);
        pushButton_menu_manual->setCheckable(true);
        pushButton_menu_manual->setAutoExclusive(true);

        bocniMenu->addWidget(pushButton_menu_manual);

        pushButton_menu_fullscreen = new QPushButton(page_palPc);
        pushButton_menu_fullscreen->setObjectName(QString::fromUtf8("pushButton_menu_fullscreen"));
        sizePolicy3.setHeightForWidth(pushButton_menu_fullscreen->sizePolicy().hasHeightForWidth());
        pushButton_menu_fullscreen->setSizePolicy(sizePolicy3);
        ...
        pushButton_menu_quit = new QPushButton(page_palPc);
        ...
        sizePolicy5.setHeightForWidth(pushButton_menu_quit->sizePolicy().hasHeightForWidth());
        pushButton_menu_quit->setSizePolicy(sizePolicy5);
        ...
        stackedWidget_palPc = new QStackedWidget(page_palPc);
        stackedWidget_palPc->setObjectName(QString::fromUtf8("stackedWidget_palPc"));
        stackedWidget_palPc->setEnabled(true);
        sizePolicy2.setHeightForWidth(stackedWidget_palPc->sizePolicy().hasHeightForWidth());
        stackedWidget_palPc->setSizePolicy(sizePolicy2);
        ...
        stackedWidget_palPc->setStyleSheet(QString::fromUtf8("/*background-color:rgb(52, 101, 164); */\n"
"*{padding: 0 0 0}"));
        ...
        sizePolicy3.setHeightForWidth(pushButton_jizda_pridat->sizePolicy().hasHeightForWidth());
        pushButton_jizda_pridat->setSizePolicy(sizePolicy3);
        QFont font2;
        font2.setPointSize(14);
        pushButton_jizda_pridat->setFont(font2);

        verticalLayout->addWidget(pushButton_jizda_pridat);
        ...
        sizePolicy3.setHeightForWidth(pushButton_jizda_ubrat->sizePolicy().hasHeightForWidth());
        pushButton_jizda_ubrat->setSizePolicy(sizePolicy3);
        pushButton_jizda_ubrat->setFont(font2);

        verticalLayout->addWidget(pushButton_jizda_ubrat);
        ...
        radioButton = new QRadioButton(page_jizda);
        radioButton->setObjectName(QString::fromUtf8("radioButton"));

        verticalLayout_6->addWidget(radioButton);

        radioButton_2 = new QRadioButton(page_jizda);
        radioButton_2->setObjectName(QString::fromUtf8("radioButton_2"));

        verticalLayout_6->addWidget(radioButton_2);

        radioButton_3 = new QRadioButton(page_jizda);
        radioButton_3->setObjectName(QString::fromUtf8("radioButton_3"));

        verticalLayout_6->addWidget(radioButton_3);

        radioButton_4 = new QRadioButton(page_jizda);
        ...
        pushButton_jizda_IBIS->setFont(font3);

        horizontalLayout_3->addWidget(pushButton_jizda_IBIS);
        ...
        sizePolicy2.setHeightForWidth(pushButton_jizda_sipkaNahoru->sizePolicy().hasHeightForWidth());
        pushButton_jizda_sipkaNahoru->setSizePolicy(sizePolicy2);
        ...
        sizePolicy3.setHeightForWidth(pushButton_jizda_sipkaDolu->sizePolicy().hasHeightForWidth());
        pushButton_jizda_sipkaDolu->setSizePolicy(sizePolicy3);
        ...
        sizePolicy3.setHeightForWidth(pushButton_jizda_beforeStop->sizePolicy().hasHeightForWidth());
        pushButton_jizda_beforeStop->setSizePolicy(sizePolicy3);
        QFont font4;
        font4.setPointSize(20);
        pushButton_jizda_beforeStop->setFont(font4);
        ...
        sizePolicy3.setHeightForWidth(pushButton_jizda_atStop->sizePolicy().hasHeightForWidth());
        pushButton_jizda_atStop->setSizePolicy(sizePolicy3);
        pushButton_jizda_atStop->setFont(font4);
        ...
        sizePolicy3.setHeightForWidth(pushButton_jizda_afterStop->sizePolicy().hasHeightForWidth());
        pushButton_jizda_afterStop->setSizePolicy(sizePolicy3);
        pushButton_jizda_afterStop->setFont(font4);
        ...
        sizePolicy3.setHeightForWidth(pushButton_jizda_betweenStop->sizePolicy().hasHeightForWidth());
        pushButton_jizda_betweenStop->setSizePolicy(sizePolicy3);
        pushButton_jizda_betweenStop->setFont(font3);
        ...
        sizePolicy2.setHeightForWidth(pushButton_prikaz->sizePolicy().hasHeightForWidth());
        pushButton_prikaz->setSizePolicy(sizePolicy2);
        pushButton_prikaz->setFont(font4);
        ...
        pushButton_nast_dnes = new QPushButton(page_nastaveni);
        ...
        pushButton_nast_hlaseniSlozka = new QPushButton(page_nastaveni);
        pushButton_nast_hlaseniSlozka->setObjectName(QString::fromUtf8("pushButton_nast_hlaseniSlozka"));
        sizePolicy7.setHeightForWidth(pushButton_nast_hlaseniSlozka->sizePolicy().hasHeightForWidth());
        pushButton_nast_hlaseniSlozka->setSizePolicy(sizePolicy7);

        verticalLayout_14->addWidget(pushButton_nast_hlaseniSlozka);
        ...
        pushButton_nast_pripojeni = new QPushButton(page_nastaveni);
        pushButton_nast_pripojeni->setObjectName(QString::fromUtf8("pushButton_nast_pripojeni"));
        pushButton_nast_pripojeni->setEnabled(false);
        sizePolicy3.setHeightForWidth(pushButton_nast_pripojeni->sizePolicy().hasHeightForWidth());
        pushButton_nast_pripojeni->setSizePolicy(sizePolicy3);

        verticalLayout_2->addWidget(pushButton_nast_pripojeni);
        ...
        pushButton_nast_truncate = new QPushButton(page_nastaveni);
        pushButton_nast_truncate->setObjectName(QString::fromUtf8("pushButton_nast_truncate"));
        pushButton_nast_truncate->setMinimumSize(QSize(0, 80));

        verticalLayoutvstupniData->addWidget(pushButton_nast_truncate);

        pushButton_nast_xmlVyberCestu = new QPushButton(page_nastaveni);
        ...
        pushButton_nast_xmlVyberCestu->setMinimumSize(QSize(0, 80));

        verticalLayoutvstupniData->addWidget(pushButton_nast_xmlVyberCestu);

        pushButton_nast_nactiXMLropid = new QPushButton(page_nastaveni);
        pushButton_nast_nactiXMLropid->setObjectName(QString::fromUtf8("pushButton_nast_nactiXMLropid"));
        pushButton_nast_nactiXMLropid->setMinimumSize(QSize(0, 80));
        ...
        pushButton_nast_nastavPort = new QPushButton(page_nastaveni);
        ...
        pushButton_nast_odesliPrikaz = new QPushButton(page_nastaveni);
        ...
        stackedWidget_palPc->addWidget(page_nastaveni);
        page_manual = new QWidget();
        page_manual->setObjectName(QString::fromUtf8("page_manual"));
        gridLayout = new QGridLayout(page_manual);
        gridLayout->setSpacing(6);
        gridLayout->setContentsMargins(11, 11, 11, 11);
        gridLayout->setObjectName(QString::fromUtf8("gridLayout"));
        lineEdit_strukturaOdberu = new QLineEdit(page_manual);
        ...
        label_11 = new QLabel(page_manual);
        label_11->setObjectName(QString::fromUtf8("label_11"));

        verticalLayout_11->addWidget(label_11);

        seznamOdberatelu = new QTableWidget(page_manual);
        if (seznamOdberatelu->columnCount() < 3)
            seznamOdberatelu->setColumnCount(3);
        QTableWidgetItem *__qtablewidgetitem5 = new QTableWidgetItem();
        seznamOdberatelu->setHorizontalHeaderItem(0, __qtablewidgetitem5);
        QTableWidgetItem *__qtablewidgetitem6 = new QTableWidgetItem();
        seznamOdberatelu->setHorizontalHeaderItem(1, __qtablewidgetitem6);
        QTableWidgetItem *__qtablewidgetitem7 = new QTableWidgetItem();
        seznamOdberatelu->setHorizontalHeaderItem(2, __qtablewidgetitem7);
        seznamOdberatelu->setObjectName(QString::fromUtf8("seznamOdberatelu"));

        verticalLayout_11->addWidget(seznamOdberatelu);

        label_15 = new QLabel(page_manual);
        label_15->setObjectName(QString::fromUtf8("label_15"));

        verticalLayout_11->addWidget(label_15);

        seznamOdberatelu2 = new QTableWidget(page_manual);
        if (seznamOdberatelu2->columnCount() < 3)
            seznamOdberatelu2->setColumnCount(3);
        QTableWidgetItem *__qtablewidgetitem8 = new QTableWidgetItem();
        seznamOdberatelu2->setHorizontalHeaderItem(0, __qtablewidgetitem8);
        QTableWidgetItem *__qtablewidgetitem9 = new QTableWidgetItem();
        seznamOdberatelu2->setHorizontalHeaderItem(1, __qtablewidgetitem9);
        QTableWidgetItem *__qtablewidgetitem10 = new QTableWidgetItem();
        seznamOdberatelu2->setHorizontalHeaderItem(2, __qtablewidgetitem10);
        ...
        label_diagnostika_manual = new QLabel(page_manual);
        label_diagnostika_manual->setObjectName(QString::fromUtf8("label_diagnostika_manual"));
        QFont font5;
        font5.setPointSize(16);
        label_diagnostika_manual->setFont(font5);

        gridLayout->addWidget(label_diagnostika_manual, 6, 5, 1, 1);

        lineEdit_ipadresaOdberatele = new QLineEdit(page_manual);
        ...
        label_10 = new QLabel(page_manual);
        label_10->setObjectName(QString::fromUtf8("label_10"));

        verticalLayout_10->addWidget(label_10);

        plainTextEditCustomXml = new QPlainTextEdit(page_manual);
        ...
        pushButton_manual_addsubscriber = new QPushButton(page_manual);
        pushButton_manual_addsubscriber->setObjectName(QString::fromUtf8("pushButton_manual_addsubscriber"));
        pushButton_manual_addsubscriber->setFont(font5);

        gridLayout_7->addWidget(pushButton_manual_addsubscriber, 1, 0, 1, 1);

        pushButton_manual_removeSubscriber_2 = new QPushButton(page_manual);
        pushButton_manual_removeSubscriber_2->setObjectName(QString::fromUtf8("pushButton_manual_removeSubscriber_2"));
        pushButton_manual_removeSubscriber_2->setFont(font5);

        gridLayout_7->addWidget(pushButton_manual_removeSubscriber_2, 2, 1, 1, 1);

        pushButton_manual_removeSubscriber = new QPushButton(page_manual);
        pushButton_manual_removeSubscriber->setObjectName(QString::fromUtf8("pushButton_manual_removeSubscriber"));
        pushButton_manual_removeSubscriber->setFont(font5);

        gridLayout_7->addWidget(pushButton_manual_removeSubscriber, 2, 0, 1, 1);

        label_13 = new QLabel(page_manual);
        label_13->setObjectName(QString::fromUtf8("label_13"));

        gridLayout_7->addWidget(label_13, 0, 0, 1, 1);

        label_14 = new QLabel(page_manual);
        label_14->setObjectName(QString::fromUtf8("label_14"));

        gridLayout_7->addWidget(label_14, 0, 1, 1, 1);

        pushButton_manual_addsubscriber_2 = new QPushButton(page_manual);
        pushButton_manual_addsubscriber_2->setObjectName(QString::fromUtf8("pushButton_manual_addsubscriber_2"));
        pushButton_manual_addsubscriber_2->setFont(font5);

        gridLayout_7->addWidget(pushButton_manual_addsubscriber_2, 1, 1, 1, 1);

        pushButton_manual_smazOkno = new QPushButton(page_manual);
        pushButton_manual_smazOkno->setObjectName(QString::fromUtf8("pushButton_manual_smazOkno"));

        gridLayout_7->addWidget(pushButton_manual_smazOkno, 1, 2, 1, 1);

        pushButton_manual_odesliXml = new QPushButton(page_manual);
        pushButton_manual_odesliXml->setObjectName(QString::fromUtf8("pushButton_manual_odesliXml"));

        gridLayout_7->addWidget(pushButton_manual_odesliXml, 2, 2, 1, 1);


        gridLayout->addLayout(gridLayout_7, 4, 0, 3, 2);

        stackedWidget_palPc->addWidget(page_manual);
        ...
        sizePolicy2.setHeightForWidth(pushButton_turnus_prikaz->sizePolicy().hasHeightForWidth());
        pushButton_turnus_prikaz->setSizePolicy(sizePolicy2);
        pushButton_turnus_prikaz->setFont(font4);
        ...
        stackedWidget_hlavni->addWidget(page_palPc);
        page_test = new QWidget();
        page_test->setObjectName(QString::fromUtf8("page_test"));
        horizontalLayout_18 = new QHBoxLayout(page_test);
        ...
        pushButton_menu2_sluzby = new QPushButton(page_test);
        pushButton_menu2_sluzby->setObjectName(QString::fromUtf8("pushButton_menu2_sluzby"));
        sizePolicy3.setHeightForWidth(pushButton_menu2_sluzby->sizePolicy().hasHeightForWidth());
        pushButton_menu2_sluzby->setSizePolicy(sizePolicy3);
        pushButton_menu2_sluzby->setMinimumSize(QSize(0, 0));
        pushButton_menu2_sluzby->setMaximumSize(QSize(200, 200));
        pushButton_menu2_sluzby->setFont(font);
        ...
        pushButton_menu2_prubehTestu = new QPushButton(page_test);
        pushButton_menu2_prubehTestu->setObjectName(QString::fromUtf8("pushButton_menu2_prubehTestu"));
        sizePolicy3.setHeightForWidth(pushButton_menu2_prubehTestu->sizePolicy().hasHeightForWidth());
        pushButton_menu2_prubehTestu->setSizePolicy(sizePolicy3);
        pushButton_menu2_prubehTestu->setMinimumSize(QSize(0, 0));
        pushButton_menu2_prubehTestu->setMaximumSize(QSize(200, 200));
        pushButton_menu2_prubehTestu->setFont(font);
        ...
        pushButton_menu2_rezerva = new QPushButton(page_test);
        pushButton_menu2_rezerva->setObjectName(QString::fromUtf8("pushButton_menu2_rezerva"));
        sizePolicy3.setHeightForWidth(pushButton_menu2_rezerva->sizePolicy().hasHeightForWidth());
        pushButton_menu2_rezerva->setSizePolicy(sizePolicy3);
        pushButton_menu2_rezerva->setMinimumSize(QSize(0, 0));
        pushButton_menu2_rezerva->setMaximumSize(QSize(200, 200));
        pushButton_menu2_rezerva->setFont(font);
        ...
        pushButton_menu2_palPc = new QPushButton(page_test);
        pushButton_menu2_palPc->setObjectName(QString::fromUtf8("pushButton_menu2_palPc"));
        sizePolicy3.setHeightForWidth(pushButton_menu2_palPc->sizePolicy().hasHeightForWidth());
        pushButton_menu2_palPc->setSizePolicy(sizePolicy3);
        pushButton_menu2_palPc->setMinimumSize(QSize(0, 0));
        pushButton_menu2_palPc->setMaximumSize(QSize(200, 200));
        pushButton_menu2_palPc->setFont(font);
        pushButton_menu2_palPc->setCheckable(true);
        pushButton_menu2_palPc->setAutoExclusive(true);

        verticalLayout_21->addWidget(pushButton_menu2_palPc);

        pushButton_menu2_fullscreen = new QPushButton(page_test);
        pushButton_menu2_fullscreen->setObjectName(QString::fromUtf8("pushButton_menu2_fullscreen"));
        sizePolicy3.setHeightForWidth(pushButton_menu2_fullscreen->sizePolicy().hasHeightForWidth());
        pushButton_menu2_fullscreen->setSizePolicy(sizePolicy3);
        pushButton_menu2_fullscreen->setMinimumSize(QSize(0, 0));
        pushButton_menu2_fullscreen->setMaximumSize(QSize(200, 200));
        pushButton_menu2_fullscreen->setFont(font);
        ...
        pushButton_menu2_quit = new QPushButton(page_test);
        pushButton_menu2_quit->setObjectName(QString::fromUtf8("pushButton_menu2_quit"));
        sizePolicy2.setHeightForWidth(pushButton_menu2_quit->sizePolicy().hasHeightForWidth());
        pushButton_menu2_quit->setSizePolicy(sizePolicy2);
        pushButton_menu2_quit->setMaximumSize(QSize(200, 200));
        QPalette palette5;
        pushButton_menu2_quit->setPalette(palette5);
        pushButton_menu2_quit->setFont(font);
        ...
        stackedWidget_testy = new QStackedWidget(page_test);
        ...
        sizePolicy3.setHeightForWidth(pushButton_startTest->sizePolicy().hasHeightForWidth());
        pushButton_startTest->setSizePolicy(sizePolicy3);
        pushButton_startTest->setFont(font);
        ...
        sizePolicy3.setHeightForWidth(pushButton_stopTest->sizePolicy().hasHeightForWidth());
        pushButton_stopTest->setSizePolicy(sizePolicy3);
        pushButton_stopTest->setFont(font);
        ...
        label_nazevSluzby_3->setFont(font);
        ...
        horizontalLayout_18->addLayout(formLayout_3);

        stackedWidget_hlavni->addWidget(page_test);
        ...
        QWidget::setTabOrder(pushButton_menu_jizda, pushButton_menu_testRozhrani);
        QWidget::setTabOrder(pushButton_menu_testRozhrani, pushButton_menu_nastaveni);
        QWidget::setTabOrder(pushButton_menu_nastaveni, pushButton_menu_manual);
        QWidget::setTabOrder(pushButton_menu_manual, pushButton_menu_fullscreen);
        ...
        QWidget::setTabOrder(pushButton_jizda_sipkaDolu, pushButton_jizda_pridat);
        QWidget::setTabOrder(pushButton_jizda_pridat, pushButton_jizda_ubrat);
        QWidget::setTabOrder(pushButton_jizda_ubrat, pushButton_jizda_beforeStop);
        QWidget::setTabOrder(pushButton_jizda_beforeStop, pushButton_jizda_atStop);
        QWidget::setTabOrder(pushButton_jizda_atStop, pushButton_jizda_afterStop);
        QWidget::setTabOrder(pushButton_jizda_afterStop, pushButton_jizda_betweenStop);
        QWidget::setTabOrder(pushButton_jizda_betweenStop, radioButton);
        ...
        QWidget::setTabOrder(radioButton_4, pushButton_jizda_IBIS);
        QWidget::setTabOrder(pushButton_jizda_IBIS, listLinek);
        QWidget::setTabOrder(listLinek, listSpoje);
        QWidget::setTabOrder(listSpoje, pushButton_prikaz);
        QWidget::setTabOrder(pushButton_prikaz, pushButton_nast_nactiXMLropid);
        QWidget::setTabOrder(pushButton_nast_nactiXMLropid, lineEdit_jmenoPortu);
        QWidget::setTabOrder(lineEdit_jmenoPortu, pushButton_nast_odesliPrikaz);
        QWidget::setTabOrder(pushButton_nast_odesliPrikaz, pushButton_nast_nastavPort);
        QWidget::setTabOrder(pushButton_nast_nastavPort, polelinky);
        QWidget::setTabOrder(polelinky, pushButton_nast_pripojeni);
        QWidget::setTabOrder(pushButton_nast_pripojeni, pushButton_nast_hlaseniSlozka);
        QWidget::setTabOrder(pushButton_nast_hlaseniSlozka, lineEditHlaseniCesta);
        ...
        QWidget::setTabOrder(pushButton_menu2_rezerva, pushButton_menu2_palPc);
        QWidget::setTabOrder(pushButton_menu2_palPc, pushButton_menu2_fullscreen);
...
"/spoj", nullptr));
        ...
        pushButton_jizda_pridat->setText(QCoreApplication::translate("MainWindow", "P\305\231idat", nullptr));
        pushButton_jizda_ubrat->setText(QCoreApplication::translate("MainWindow", "Ubrat", nullptr));
...
"Stop", nullptr));
        ...
        pushButton_nast_hlaseniSlozka->setText(QCoreApplication::translate("MainWindow", "nastav slozku", nullptr));
        ...
        pushButton_nast_pripojeni->setText(QCoreApplication::translate("MainWindow", "SQL Connect", nullptr));
        ...
        pushButton_nast_truncate->setText(QCoreApplication::translate("MainWindow", "Vymazat data z DB", nullptr));
        pushButton_nast_xmlVyberCestu->setText(QCoreApplication::translate("MainWindow", "Vyber cestu XML", nullptr));
        pushButton_nast_nactiXMLropid->setText(QCoreApplication::translate("MainWindow", "nactiXML", nullptr));
        ...
        pushButton_nast_nastavPort->setText(QCoreApplication::translate("MainWindow", "nastav \304\215\303\255slo portu", nullptr));
        pushButton_nast_odesliPrikaz->setText(QCoreApplication::translate("MainWindow", "odesliPrikaz", nullptr));
...
""
        ...
        pushButton_manual_smazOkno->setText(QCoreApplication::translate("MainWindow", "Vyma\305\276 okno", nullptr));
        pushButton_manual_odesliXml->setText(QCoreApplication::translate("MainWindow", "ode\305\241li na panely", nullptr));
...
" testu", nullptr));
        ...
        pushButton_menu2_palPc->setText(QCoreApplication::translate("MainWindow", "PalPC", nullptr));
