...
QByteArray xmlGenerator::AllData(int poradi, int pocetZastavek, QVector <SeznamZastavek> docasnySeznamZastavek, int docasLinka, QString doorState, QString locationState, QByteArray Connections)
{
