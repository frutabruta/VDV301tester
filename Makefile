...
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile BakalarkaTest1.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_DEPRECATED_WARNINGS -DQT_QML_DEBUG -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_SQL_LIB -DQT_XML_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB
...
DISTDIR = /home/pi/github/VDV301tester-master/.tmp/BakalarkaTest11.0.0
LINK          = g++
LFLAGS        = 
...
SOURCES       = main.cpp \
		...
		xmlgenerator.cpp \
		cestaudaje.cpp \
		xmlmpvparser.cpp moc_mainwindow.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents mainwindow.h prestupmpv.h sqlprace.h httpserver/myhttpserver.h VDV301_Display/seznamzastavek.h xmlgenerator.h cestaudaje.h xmlmpvparser.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp mainwindow.cpp prestupmpv.cpp sqlprace.cpp httpserver/myhttpserver.cpp VDV301_Display/seznamzastavek.cpp xmlgenerator.cpp cestaudaje.cpp xmlmpvparser.cpp $(DISTDIR)/
...
moc_predefs.h: /usr/lib/arm-linux-gnueabihf/qt5/mkspecs/features/data/dummy.cpp
	g++ -pipe -g -Wall -W -dM -E -o moc_predefs.h /usr/lib/arm-linux-gnueabihf/qt5/mkspecs/features/data/dummy.cpp
